...
public:
    ...
    std::vector<int> getCoPilotIDs(){return copilotIDs;}; //vector of all the pilots aboard a flight.
    ...
    void setCoPilotIDs(std::vector<int> ids){copilotIDs=ids;}; //vector of all the copilots aboard a flight.
